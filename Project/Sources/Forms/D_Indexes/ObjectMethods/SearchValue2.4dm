...
$SearchButton:="SearchButton2"  //magnifiing glass used to select criteria
$SearchClose:="SearchClose2"  //close box to clear the critéria
...
Case of 
	...
	: ($event=On After Keystroke:K2:26)
		...
		Else 
			...
			ChronoStart
			QUERY:C277([CONTACTS:6]; [CONTACTS:6]LastName:3=$CurrentText+"@")
			ChronoStop
